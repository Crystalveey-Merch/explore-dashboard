...
export const PrivateBookingRow = ({ booking, handleDelete }: { booking: any, handleDelete: (id: string) => void }) => {
    ...
    const viewRoute = `/explore/flight-bookings/${booking.id}`;
    ...
    return (
        <tr className="bg-white border-b hover:bg-gray-50">
            ...
            <td className="px-6 py-4 2xl:px-4 xl:px-3">
                <p className="text-[rgb(33,43,54)] text-sm font-normal whitespace-nowrap xl:text-xs">
                    {handleFormatDateB(booking.departureDate)}
                </p>
            </td>
            <td className="px-6 py-4 2xl:px-4 xl:px-3">
                <p className="text-[rgb(33,43,54)] text-sm font-normal whitespace-nowrap xl:text-xs">
                    {handleFormatDateB(booking.returnDate)}
                </p>
            </td>
            <td className="px-6 py-4 2xl:px-4 xl:px-3">
                <p className="text-[rgb(33,43,54)] text-sm font-normal whitespace-nowrap xl:text-xs">
