...
export const ConfirmedBookingForPayments = async (recipientEmail: string, firstName: string, price: string, bookingId: string, travellers: any, bookingDate: any, checkInDate: any, itemName: string) => {
    try {
