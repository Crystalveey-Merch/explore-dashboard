...
export const RefundedActivities = () => {
    ...
    useEffect(() => {
        const fetchTravelBookings = async () => {
            ...
            setActivitiesBookings(bookings.filter((booking: { type: string, paymentStatus: string }) => booking.type === "Exciting Activities" && booking.paymentStatus === "refunded"));
            setLoading(false);
        }
        fetchTravelBookings()
    }, [])
