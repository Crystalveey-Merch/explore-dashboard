...
export const RefundedTours = ({ allTourBookings }: { allTourBookings: any[] }) => {
    ...
    useEffect(() => {
        setLoading(true);
        // set bookings of type "Tour Packages"  and status "refunded" to state
        setTourBookings(allTourBookings.filter((booking: { type: string, paymentStatus: string }) => booking.type === "Tour Packages" && booking.paymentStatus === "refunded"));
        setLoading(false);
    }, [allTourBookings]);
