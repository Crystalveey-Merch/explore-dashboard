...
import { db, collection, addDoc, serverTimestamp, storage } from "../../../Config/firebase";
...
export const AddBlog = () => {
    ...
    //             const storageRef = ref(storage, `blogs/${photo.name}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            await addDoc(blogRef, {
                ...
                createdAt: timestamp,
                updatedAt: timestamp,
                authorName: user?.displayName ? user.displayName : "Admin",
